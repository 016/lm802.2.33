...
target_ssl_path="/usr/syno/etc/certificate/_archive/YKv5fl"

# 执行ssl替换操作
# Perform ssl replacement operation
cp -r "${original_ssl_path}/lib00.com.cer" "${target_ssl_path}/cert.pem"
cp -r "${original_ssl_path}/lib00.com.key" "${target_ssl_path}/privkey.pem"
cp -r "${original_ssl_path}/fullchain.cer" "${target_ssl_path}/fullchain.pem"
